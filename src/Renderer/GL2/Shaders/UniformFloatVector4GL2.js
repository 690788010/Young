...
class UniformFloatVector4GL2 extends Uniform{
  /**
   * 构造函数
  ...
  clean(gl) {
    if (this._dirty) {
      gl.uniform4fv(this._location, new Float32Array([this._value.X, this._value.Y, this._value.Z, this._value.W]));
      this._dirty = false;
    }
  }
}

export default UniformFloatVector4GL2;